            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="text-xs font-medium uppercase text-slate-500">{{ __('admin.bookings.table.adults') ?? 'Adults' }}</label>
                            <p class="mt-1 text-slate-700">{{ $booking->adults_count }}</p>
                        </div>
                        <div>
                            <label class="text-xs font-medium uppercase text-slate-500">{{ __('admin.bookings.table.young') ?? 'Young' }}</label>
