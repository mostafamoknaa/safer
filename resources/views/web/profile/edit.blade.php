                    ...
                    <div class="flex flex-col md:flex-row gap-8">
                        ...
                        <div class="flex-1 md:order-1 space-y-5 text-right">
                            ...
                            <div>
                                ...
                                <input type="password" name="new_password" placeholder="********" autocomplete="new-password" class="w-full bg-gray-50 border-gray-100 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition outline-none text-right" dir="ltr">
                            </div>

                            <div>
                                <label class="block text-gray-700 font-bold mb-2">تأكيد كلمة المرور</label>
                                <input type="password" name="new_password_confirmation" placeholder="********" autocomplete="new-password" class="w-full bg-gray-50 border-gray-100 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition outline-none text-right" dir="ltr">
                            </div>
