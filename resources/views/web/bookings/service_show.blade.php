                        ...
                        <div>
                            <span class="status-badge status-{{ $request->status }}">
                                @switch($request->status)
                                    ...
                                    @case('confirmed') @case('approved') تم التأكيد @break
            ...
            <div class="lg:col-span-1 space-y-8">
                ...
                <div class="booking-card p-6 text-right">
                    ...
                    <div class="space-y-3">
                        ...
                        @if(in_array($request->status, ['confirmed', 'approved']))
                        ...
                        <a href="{{ route('web.payments.initiate', ['type' => 'service_request', 'id' => $request->id]) }}" 
