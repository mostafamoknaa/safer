...
<head>
    ...
    <title>سافر | اكتشاف الأماكن</title>
...
<body class="bg-gray-50">
    ...
    <div class="container mx-auto px-4 py-12">
        <div class="mb-10">
            <h1 class="text-4xl font-bold text-gray-900 mb-2 border-r-4 border-blue-600 pr-4">{{ $title ?? 'اكتشاف الأماكن' }}</h1>
            <p class="text-gray-600 pr-6">استكشف أفضل الوجهات والفعاليات المميزة</p>
        </div>
