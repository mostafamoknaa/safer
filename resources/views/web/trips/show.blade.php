        ...
        <div class="max-w-6xl mx-auto">
            <div class="bg-white rounded-[24px] overflow-hidden shadow-lg border border-gray-100">
                ...
                <div class="relative h-64 md:h-96 overflow-hidden group">
                    ...
                    {{-- Date Badge --}}
                    <div class="absolute top-6 right-6 bg-safer-blue text-white px-4 py-2 rounded-xl text-sm font-bold shadow-lg">
                ...
                <div class="p-6 md:p-8">
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="lg:col-span-2">
                            <h1 class="text-3xl md:text-4xl font-bold text-gray-900 mb-6 border-r-4 border-safer-blue pr-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                                <div class="flex items-center gap-3 bg-gray-50 p-4 rounded-xl border border-gray-100">
                                    <div class="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center text-safer-blue">
                                ...
                                <div class="flex items-center gap-3 bg-gray-50 p-4 rounded-xl border border-gray-100">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-bold text-gray-900">{{ \Carbon\Carbon::parse($trip->trip_time)->format('h:i A') }}</p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-3 bg-gray-50 p-4 rounded-xl border border-gray-100">
                            ...
                            @if($trip->bus)
                                <div class="mb-8">
                                    <h3 class="text-2xl font-bold text-gray-900 mb-4 border-r-4 border-safer-blue pr-3">معلومات الحافلة</h3>
                                    <div class="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                                        <div class="grid grid-cols-2 md:grid-cols-3 gap-6">
                                            ...
                                            <div>
                                                ...
                                                <p class="font-bold text-green-600 bg-green-50 px-3 py-1 rounded-full inline-block">{{ $trip->available_seats_count }} متاح</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="prose max-w-none">
                                <h3 class="text-2xl font-bold text-gray-900 mb-4 border-r-4 border-safer-blue pr-3">عن الرحلة</h3>
                                <p class="text-gray-600 leading-relaxed text-lg bg-gray-50/50 p-6 rounded-2xl border border-gray-100">
                                    استمتع برحلة مريحة وآمنة من {{ $trip->departure_location_ar }} إلى {{ $trip->arrival_location_ar }}. 
                                    نوفر لك أفضل خدمة نقل مع حافلات حديثة ومجهزة بأحدث وسائل الراحة لضمان وصولك إلى وجهتك بأمان وراحة تامة.
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="bg-gray-50 rounded-2xl p-6 sticky top-24 border border-gray-100 shadow-sm">
                                <div class="mb-6 pb-6 border-b border-gray-200">
                                    <div class="flex items-baseline gap-2 mb-2">
                                        <span class="text-4xl font-bold text-safer-blue">{{ number_format($trip->price) }}</span>
                                ...
                                @auth
                                    @if($trip->bus && $trip->bus->available_seats > 0 && $trip->trip_date >= now()->toDateString())
                                        <form method="POST" action="{{ route('web.services.bus-request') }}" class="space-y-4">
                                            @csrf
                                            ...
                                            <div>
                                                ...
                                                <div class="relative">
                                                    <input type="number" 
                                                        ...
                                                        min="1" 
                                                        max="{{ $trip->bus->available_seats }}"
                                                        value="1" 
                                                        class="w-full border border-gray-200 rounded-xl px-4 py-3 pl-10 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition outline-none text-left" dir="ltr">
                                            ...
                                            <div class="bg-blue-50 rounded-xl p-4 border border-blue-100">
                                                <div class="flex justify-between items-center">
                                                    ...
                                                    <span class="text-2xl font-bold text-safer-blue" id="total-price">{{ number_format($trip->price) }} ج.م</span>
                                                </div>
                                            </div>
                                        ...
                                        <script>
                                            document.querySelector('input[name="number_of_seats"]').addEventListener('input', function() {
                                    ...
                                    @elseif(!$trip->bus || $trip->bus->available_seats == 0)
                                        <div class="bg-red-50 border-2 border-red-100 text-red-600 px-6 py-8 rounded-xl text-center">
                                    ...
                                    @else
                                        <div class="bg-gray-100 border-2 border-gray-200 text-gray-600 px-6 py-8 rounded-xl text-center">
                                    ...
                                    @endif
                                @else
                                    <div class="bg-yellow-50 border-2 border-yellow-100 text-yellow-800 px-6 py-8 rounded-xl text-center">
                                        ...
                                        <p class="mt-4 text-sm">
                                            ليس لديك حساب؟ 
                                            <a href="{{ route('register') }}" class="text-safer-blue font-bold hover:underline">أنشئ حساب جديد</a>
                                        </p>
                                    </div>
                                @endauth
                            </div>
