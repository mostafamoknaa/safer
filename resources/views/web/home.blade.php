...
<head>
    ...
    <style>
        ...
        .hero-bg {
            background-image: url('{{ asset('Home_page.png') }}');
...
<body class="bg-white">
    ...
    <section class=" hero-bg relative flex flex-col items-center justify-center text-center px-4">
        <h1 class="text-white text-4xl md:text-6xl font-bold z-10 mb-12">+Not Just Travel, Safer</h1>
    ...
    <script>
        ...
        if ("geolocation" in navigator) {
            navigator.geolocation.getCurrentPosition(function (position) {
                ...
                fetch(`/api/hotels/nearest?lat=${lat}&lng=${lng}`, { credentials: 'same-origin' })
                    .then(response => response.json())
                    .then(data => {
