...
<div class="p-6">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900">تعديل رحلة</h1>
    </div>

    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('hotel.trips.update', $trip) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="departure_location_ar" id="departure_location_ar" value="{{ old('departure_location_ar', $trip->departure_location_ar) }}" 
                ...
                <div>
                    ...
                    <input type="text" name="departure_location_en" id="departure_location_en" value="{{ old('departure_location_en', $trip->departure_location_en) }}" 
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                ...
                <div>
                    ...
                    <input type="text" name="arrival_location_ar" id="arrival_location_ar" value="{{ old('arrival_location_ar', $trip->arrival_location_ar) }}" 
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                ...
                <div>
                    ...
                    <input type="text" name="arrival_location_en" id="arrival_location_en" value="{{ old('arrival_location_en', $trip->arrival_location_en) }}" 
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                ...
                <div>
                    ...
                    <input type="number" name="price" id="price" value="{{ old('price', $trip->price) }}" step="0.01" min="0"
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                    @error('price')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="date" name="trip_date" id="trip_date" value="{{ old('trip_date', $trip->trip_date->format('Y-m-d')) }}" 
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                    @error('trip_date')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="time" name="trip_time" id="trip_time" value="{{ old('trip_time', $trip->trip_time) }}" 
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                    @error('trip_time')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="number" name="duration_minutes" id="duration_minutes" value="{{ old('duration_minutes', $trip->duration_minutes) }}" min="1"
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
            ...
            <div class="mt-6">
                <label class="flex items-center">
                    <input type="checkbox" name="is_active" value="1" {{ old('is_active', $trip->is_active) ? 'checked' : '' }}
