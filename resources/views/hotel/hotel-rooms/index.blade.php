 ...
 <!-- Clone Modal -->
        ...
        <div class="mx-4 w-full max-w-md rounded-xl bg-white p-6 shadow-xl">
            ...
            <form id="cloneForm" method="POST">
                ...
                <div class="flex justify-end gap-3">
                    ...
                    <button type="submit" 
                            class="rounded-lg bg-black-600 px-4 py-2 text-sm font-medium  hover:bg-green-700">
                        استنساخ
                    </button>
                </div>
            </form>
    ...
    <script>
        ...
        function getCsrfToken() {
            ...
            return existingToken ? existingToken.value : '';
        }

        function openCloneModal(roomId) {
            const form = document.getElementById('cloneForm');
            form.action = `/hotel/hotel-rooms/${roomId}/clone`;
